...
(29, 'Forêts d''érables', 'Chantal Goulet', '148 rue Chasseur', 'Ste-Hyacinthe', 'J2S 7S8', 'Canada', '(514) 555-2955');CREATE INDEX idx_orders_customer_id ON Orders(CustomerID);
CREATE INDEX idx_orders_employee_id ON Orders(EmployeeID);
CREATE INDEX idx_orders_shipper_id ON Orders(ShipperID);
CREATE INDEX idx_order_details_order_id ON OrderDetails(OrderID);
CREATE INDEX idx_order_details_product_id ON OrderDetails(ProductID);
